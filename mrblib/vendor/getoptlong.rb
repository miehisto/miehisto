...
# Original CRuby version is here:
# https://github.com/ruby/ruby/blob/v2_6_1/lib/getoptlong.rb
# Added some patches by Uchio Kondo <udzura@udzura.jp>
...
class GetoptLong
  ...
  def initialize(*arguments)
    ...
    #
    # Copy ARGV on initialize not to destroy
    #
    @ARGV = ARGV.dup
